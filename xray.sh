...
install_XrayR() {
    ...
    wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/XrayR-project/XrayR/releases/download/${last_version}/XrayR-linux-64.zip
...
if [ $type == 'Shadowsocks' ]; then
    ...
    wget -q -N --no-check-certificate -O /etc/nginx/nginx.conf https://www.wkao.in/bash/nginx.conf
